...
public class ContainerCookingTable extends ContainerWorkbench {
  ...
  public boolean canInteractWith(EntityPlayer par1EntityPlayer) {
    return this.world.getBlock(this.posX, this.posY, this.posZ) != Machines.CookingTable ? false : par1EntityPlayer.getDistanceSq((double) this.posX + 0.5D, (double) this.posY + 0.5D, (double) this.posZ + 0.5D) <= 64.0D;
  }
}
