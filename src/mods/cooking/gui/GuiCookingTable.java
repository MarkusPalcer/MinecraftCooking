...
public class GuiCookingTable extends GuiContainer {
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("container.cookingtable"), 28, 6, 4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.func_110577_a(new ResourceLocation("cooking","textures/gui/crafting.png"));
